	...
	theme: {
		extend: {
			...
			colors: {
				...
				// Muted secondary text (eyebrows, dates, footer, de-emphasized links).
				// Tuned to clear WCAG AA (4.5:1) against surface/surface-dark, unlike
				// stone-400/stone-600 which fall to ~2.4-2.6:1 on this background.
				muted: {
					DEFAULT: '#78716c',
					dark: '#8a8580'
				}
